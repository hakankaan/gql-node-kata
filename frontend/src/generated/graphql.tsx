...
export type GetNodeQuery = { __typename?: 'Query', node?: { __typename: 'Author', name: string, bio?: string | null, id: string } | { __typename: 'Book', title: string, createdAt: string, pages?: number | null, id: string, author: { __typename?: 'Author', id: string, name: string } } | { __typename: 'Review', title: string, createdAt: string, rating: number, content: string, id: string, book: { __typename?: 'Book', id: string, title: string } } | { __typename: 'User', id: string } | null };
